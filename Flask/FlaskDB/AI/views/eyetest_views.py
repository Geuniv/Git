...
#
# # 백내장 테스트
# @bp.route('/eyetest' , methods=['GET', 'POST'])
# def camera():
#     print('eyetest')
...
# height = 720
#
# font = ImageFont.truetype('../static/fonts/H2GSRB.TTF', 40)
# logo = cv2.imread('C:\pythonProject3\static\button\eye.png', cv2.IMREAD_UNCHANGED)
# print(str(logo)+'****************************')
# logo = cv2.resize(logo, (80, 80))
# face = cv2.resize(cv2.imread('static/button/face.png', cv2.IMREAD_UNCHANGED), (80, 80))
...
# df.to_csv('../static/csv파일/eyetest.csv')
#
# testEnd = False
# another = False
# List = []
...
# mp_hands = mp.solutions.hands
#
# btn_right = cv2.resize(cv2.imread('../static/button/lightblue.png', cv2.IMREAD_UNCHANGED), (80, 80))
...
# test = cv2.resize(cv2.imread('../static/image/test1.png', cv2.IMREAD_UNCHANGED), (300, 210))
# font = ImageFont.truetype('../static/fonts/NanumGothicBold.otf', 35)
# font = ImageFont.truetype('../static/fonts/H2GSRB.TTF', 40)
# background = cv2.resize(cv2.imread('../static/image/background.jpg'), (1000, 630))
#
# @bp.route('/eyetest_video')
# def eyetest_video():
#     def eyeTes_def(idx):
#         df = pd.read_csv('../static/csv파일/eyetest.csv')
...
#                                  ImageFont.truetype('../static/fonts/H2GSRB.TTF', 40), (0, 0, 0))
#                         List = []
...
#             else:
#                 image_def(background)
#                 text_def((320, 220), "시력테스트 검사결과 ", ImageFont.truetype('../static/fonts/H2GSRB.TTF', 70), (0, 0, 0))
...
#     df.to_csv('../static/csv파일/시력테스트.csv')
#     print(finalList)
#
#
...
#     return Response(eyetest_video(),mimetype='multipart/x-mixed-replace; boundary=frame')
#
#
