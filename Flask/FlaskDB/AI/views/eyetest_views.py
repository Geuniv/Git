...
btn_right = cv2.resize(cv2.imread('C:/Users/user/Desktop/pythonProject/pythonProject/Git/Flask/FlaskDB/AI/static/assets/img/button/lightblue.png', cv2.IMREAD_UNCHANGED), (80, 80))
...
cap = cv2.VideoCapture(0)
def gen(cap):
    global testEnd, another, image, eye, idx, List, answer_idx, eyeName, eyeText
            ...
            if testEnd is False:
                if faces:
                    ...
                    if another is False:
                        ...
                        text_def((35, 607), f'{eye}: {len(List)}', ImageFont.truetype('C:Users/user/Desktop/pythonProject/pythonProject/Git/Flask/FlaskDB/AI/static/fonts/H2GSRB.TTF', 30),
                                 (0, 0, 0))
                    else:
                        eyeText, eyeImg, eyeName = eyeTes_def(idx)
